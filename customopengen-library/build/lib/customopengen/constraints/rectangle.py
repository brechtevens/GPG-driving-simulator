...
import customopengen.functions as fn
import casadi as cs
...
class Rectangle(Constraint):
    ...
    def __init__(self, xmin, xmax):
        ...
        self.__xmin = None if xmin is None else [float(i) if isinstance(i, int) else i for i in xmin]
        self.__xmax = None if xmax is None else [float(i) if isinstance(i, int) else i for i in xmax]
