...
fn main() {
    ...
    // Check for Rectangle lower
    assert!(
        Path::new("extern/auto_casadi_rectangle_lower.c").exists(),
        "extern/auto_casadi_rectangle_lower.c is missing"
    );

    // Check for Rectangle upper
    assert!(
        Path::new("extern/auto_casadi_rectangle_upper.c").exists(),
        "extern/auto_casadi_rectangle_upper.c is missing"
    );
    ...
    cc::Build::new()
        ...
        .file("extern/auto_casadi_rectangle_lower.c")
        .file("extern/auto_casadi_rectangle_upper.c")
    ...
    println!("cargo:rerun-if-changed=extern/auto_casadi_rectangle_lower.c");
    println!("cargo:rerun-if-changed=extern/auto_casadi_rectangle_upper.c");
