...
/*
 * Rectangle lower bounds sizes
 */
#define LB_SZ_ARG_{{ meta.optimizer_name | upper}} {{ lb.sz_arg() }}
#define LB_SZ_IW_{{ meta.optimizer_name | upper}} {{ lb.sz_iw() }}
#define LB_SZ_W_{{ meta.optimizer_name | upper}} {{ lb.sz_w() }}
#define LB_SZ_RES_{{ meta.optimizer_name | upper}} {{ lb.sz_res() }}

/*
 * Rectangle upper bounds sizes
 */
#define UB_SZ_ARG_{{ meta.optimizer_name | upper}} {{ ub.sz_arg() }}
#define UB_SZ_IW_{{ meta.optimizer_name | upper}} {{ ub.sz_iw() }}
#define UB_SZ_W_{{ meta.optimizer_name | upper}} {{ ub.sz_w() }}
#define UB_SZ_RES_{{ meta.optimizer_name | upper}} {{ ub.sz_res() }}